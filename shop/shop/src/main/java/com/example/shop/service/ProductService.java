...
public class ProductService {
    ...
    // trả về sản phẩm hot ( sắp xếp cellCount giảm dần -> lấy ra N sản phẩm)
    public List<Product> getProductHot(int count){
        //Collections.sort(products.cell);

//        Collections.sort(products, new Comparator<Product>() {
//            @Override
//            public int compare(Product sp1, Product sp2) {
//                if (sp1.getSellCount() < sp2.getSellCount()) {
//                    return 1;
//                } else {
//                    if (sp1.getSellCount() == sp2.getSellCount()) {
//                        return 0;
